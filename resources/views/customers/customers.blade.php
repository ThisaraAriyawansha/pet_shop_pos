        ...
        <div class="grid h-full p-6 w-fit place-items-center">
            ...
            <div class="grid gap-6">
                <div
                    ...
                    <a href="{{ asset('customers/addCustomer')}}">
                    <div 
                        ...
                        <div class="w-10 h-10"
                            style="background: url('{{ asset('images/customer/addNewCustomer.png') }}') 
                                no-repeat;
                            background-size: cover;">
                        </div>
                        <p class="text-center max-sm:text-sm">Add New Customers</p>
                    </div>
                    </a>
                    @endif
                ...
                <div
                    ...
                    <a href="{{ asset('customers/customerList')}}">
                    <div 
                        class="w-[200px] max-lg:w-[150px]  border-2 border-[{{ $settings[7]->value}}] h-[200px] max-lg:h-[150px]  bg-[{{ $settings[7]->value}}] text-white rounded-lg flex flex-col gap-3 justify-center items-center hover:scale-90 transition-all cursor-pointer">
                        <div class="w-20 h-10"
                            style="background: url('{{ asset('images/customer/customerList.png') }}')no-repeat;background-size: cover;">
                        </div>
                        <p class="text-center max-sm:text-sm">Customers List</p>
                    </div>
                    </a>
                    @endif

                    @if(has_permission(41))
                    <a href="{{ asset('customers/importCustomer')}}">
                    <div 
                        class="w-[200px] max-lg:w-[150px]  border-2 border-[{{ $settings[7]->value}}] h-[200px] max-lg:h-[150px]  bg-[{{ $settings[7]->value}}] text-white rounded-lg flex flex-col gap-3 justify-center items-center hover:scale-90 transition-all cursor-pointer">
                        <div class="w-10 h-10"
                            style="background: url('{{ asset('images/customer/importCustomer.png') }}')no-repeat;background-size: cover;">
                        </div>
                        <p class="text-center max-sm:text-sm">Import Customers</p>
                    </div>
                    </a>
                    @endif
