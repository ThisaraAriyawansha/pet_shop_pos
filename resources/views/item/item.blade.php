...
<div class="min-h-screen bg-gray-50">
    ...
    <div class="grid grid-cols-1 gap-6 p-8 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
        ...
        <a href="{{ asset('item/add_item')}}" class="group">
            <div class="h-full p-6 transition-all duration-300 transform bg-white shadow-sm rounded-xl hover:shadow-md hover:-translate-y-1">
                <div class="flex flex-col items-center justify-center h-full text-center">
                    ...
                    <h3 class="text-lg font-medium text-gray-800">Add New Item</h3>
        ...
        <a href="{{ asset('item/add_category')}}" class="group">
            <div class="h-full p-6 transition-all duration-300 transform bg-white shadow-sm rounded-xl hover:shadow-md hover:-translate-y-1">
                <div class="flex flex-col items-center justify-center h-full text-center">
                    ...
                    <p class="mt-1 text-sm text-gray-500">Create product categories</p>
                </div>
            </div>
        </a>
        @endif
        ...
        <a href="{{ asset('item/item_list')}}" class="group">
            <div class="h-full p-6 transition-all duration-300 transform bg-white shadow-sm rounded-xl hover:shadow-md hover:-translate-y-1">
                <div class="flex flex-col items-center justify-center h-full text-center">
                    ...
                    <h3 class="text-lg font-medium text-gray-800">Items List</h3>
                    <p class="mt-1 text-sm text-gray-500">View and manage all products</p>
                </div>
            </div>
        </a>
        @endif
        ...
        <a href="{{ asset('item/category_list')}}" class="group">
            <div class="h-full p-6 transition-all duration-300 transform bg-white shadow-sm rounded-xl hover:shadow-md hover:-translate-y-1">
                <div class="flex flex-col items-center justify-center h-full text-center">
                    ...
                    <h3 class="text-lg font-medium text-gray-800">Category List</h3>
                    <p class="mt-1 text-sm text-gray-500">View and manage categories</p>
                </div>
            </div>
        </a>
        @endif
        ...
        <a href="{{ asset('item/importItem')}}" class="group">
            <div class="h-full p-6 transition-all duration-300 transform bg-white shadow-sm rounded-xl hover:shadow-md hover:-translate-y-1">
                <div class="flex flex-col items-center justify-center h-full text-center">
                    <div class="p-4 mb-4 transition-colors duration-300 rounded-full bg-indigo-50 group-hover:bg-indigo-100">
                    ...
                    <h3 class="text-lg font-medium text-gray-800">Import Items</h3>
                    <p class="mt-1 text-sm text-gray-500">Bulk import products</p>
                </div>
            </div>
        </a>
        @endif
        ...
        <a href="{{ asset('item/genarateCode')}}" class="group">
            <div class="h-full p-6 transition-all duration-300 transform bg-white shadow-sm rounded-xl hover:shadow-md hover:-translate-y-1">
                <div class="flex flex-col items-center justify-center h-full text-center">
                    ...
                    <h3 class="text-lg font-medium text-gray-800">Generate QR/Barcode</h3>
                    <p class="mt-1 text-sm text-gray-500">Create product identifiers</p>
                </div>
            </div>
        </a>
    </div>
