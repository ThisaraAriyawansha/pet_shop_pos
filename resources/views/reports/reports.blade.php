    ...
    <div class="h-5/6 max-lg:h-[83vh] flex flex-col items-center">
        ...
        <div class="grid h-full p-6 w-fit place-items-center">
            ...
            <div class="grid gap-6">
                <div
                    class="grid grid-cols-2 place-items-center max-[375px]:grid-cols-1 place-content-center [375px]:justify-items-center h-full gap-6 text-white 2xl:scale-[110%]">
                    ...
                    <div
                        ...
                        <div class="w-10 h-10"
                            style="background: url('{{ asset('images/reports/salesReport.png') }}')
                                no-repeat;
                            background-size: cover;">
                        </div>
                        <p class="text-center max-sm:text-sm">Sales Report</p>
                    </div>
                    </a>
                    @endif
                    ...
                    <div
                        class="w-[200px] max-lg:w-[150px]  border-2 border-[{{ $settings[7]->value}}] h-[200px] max-lg:h-[150px]  bg-[{{ $settings[7]->value}}] text-white rounded-lg flex flex-col gap-3 justify-center items-center hover:scale-90 transition-all cursor-pointer">
                        <div class="w-10 h-10"
                            style="background: url('{{ asset('images/reports/ItemStockReport.png') }}')
                                no-repeat;
                            background-size: cover;">
                        </div>

                        <p class="text-center max-sm:text-sm">Item Stock Report</p>
                    </div>
                    </a>
                    @endif
                ...
                <div
                    ...
                    <div
                        class="w-[200px] max-lg:w-[150px]  border-2 border-[{{ $settings[7]->value}}] h-[200px] max-lg:h-[150px]  bg-[{{ $settings[7]->value}}] text-white rounded-lg flex flex-col gap-3 justify-center items-center hover:scale-90 transition-all cursor-pointer">
                        <div class="w-10 h-10"
                            style="background: url('{{ asset('images/reports/itemReport.png') }}')
                                no-repeat;
                            background-size: cover;">
                        </div>

                        <p class="text-center max-sm:text-sm">Item Report</p>
                    </div>
                    </a>
                    @endif
                    @if (has_permission(81))
                    <a href="{{ asset('expenses/expensesList')}}">
                    <div
                        class="w-[200px] max-lg:w-[150px]  border-2 border-[{{ $settings[7]->value}}] h-[200px] max-lg:h-[150px]  bg-[{{ $settings[7]->value}}] text-white rounded-lg flex flex-col gap-3 justify-center items-center hover:scale-90 transition-all cursor-pointer">
                        <div class="w-10 h-10"
                            style="background: url('{{ asset('images/reports/ExpenseReport.png') }}')
                                no-repeat;
                            background-size: cover;">
                        </div>
                        <p class="text-center max-sm:text-sm">Expences Report</p>
                    </div>
                    </a>
                    @endif
